$(function(){
    var event = {
        makeCenter : function(){
            $('#choose-box-wrapper-school').css("display","block");
            $('#choose-box-wrapper-school').css("position","absolute");
            $('#choose-box-wrapper-school').css("top", "100px");
            $('#choose-box-wrapper-school').css("left", "-200px");
        },
        ...
        initSchool : function(provinceID){
            ...
            $('.school-item').bind('click', function(){
                    ...
                    //关闭弹窗
                    $('#choose-box-wrapper-school').css("display","none");
                }
            );
